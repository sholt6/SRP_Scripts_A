...
#sets any NA or -inf values to 0
...
#
fit_Rn4_untrimmed <- treat(fit_Rn4_untrimmed, lfc=1.5, trend=TRUE, robust=TRUE)
...
output_Rn4_untrimmed <- toptable(fit_Rn4_untrimmed, coef=1, adjust="none",n=Inf)
write.table(output_Rn4_untrimmed, file="/home/tes9/Desktop/groupproject/files/R/results/rless_output_Rn4_untrimmed.csv", row.names = TRUE,sep="\t",quote=FALSE)
...
fit_Rn4_trimmed <- treat(fit_Rn4_trimmed, lfc=1.5, trend=TRUE, robust=TRUE)
results_Rn4_trimmed <- decideTests(fit_Rn4_trimmed,adjust.method="none")
output_Rn4_trimmed <- toptable(fit_Rn4_trimmed, coef=1, adjust="none",n=Inf)
write.table(output_Rn4_trimmed, file="/home/tes9/Desktop/groupproject/files/R/results/rless_output_Rn4_trimmed.csv", row.names = TRUE,sep="\t",quote=FALSE)
...
fit_Rn6_untrimmed <- treat(fit_Rn6_untrimmed, lfc=1.5, trend=TRUE, robust=TRUE)
results_Rn6_untrimmed <- decideTests(fit_Rn6_untrimmed,adjust.method="none")
output_Rn6_untrimmed <- toptable(fit_Rn6_untrimmed, coef=1, adjust="none",n=Inf)
write.table(output_Rn6_untrimmed, file="/home/tes9/Desktop/groupproject/files/R/results/rless_output_Rn6_untrimmed.csv", row.names = TRUE,sep="\t",quote=FALSE)
...
fit_Rn6_trimmed <- treat(fit_Rn4_trimmed, lfc=1.5, trend=TRUE, robust=TRUE)
results_Rn6_trimmed <- decideTests(fit_Rn6_trimmed,adjust.method="none")
output_Rn6_trimmed <- toptable(fit_Rn6_trimmed, coef=1, adjust="none",n=Inf)
write.table(output_Rn6_trimmed, file="/home/tes9/Desktop/groupproject/files/R/results/rless_output_Rn6_trimmed.csv", row.names = TRUE,sep="\t",quote=FALSE)

write.table(results_Rn4_untrimmed, file="/home/tes9/Desktop/groupproject/files/R/results/rless_results_Rn4_untrimmed.csv", row.names = TRUE,sep="\t",quote=FALSE)
write.table(results_Rn4_trimmed, file="/home/tes9/Desktop/groupproject/files/R/results/rless_results_Rn4_trimmed.csv", row.names = TRUE,sep="\t",quote=FALSE)
write.table(results_Rn6_untrimmed, file="/home/tes9/Desktop/groupproject/files/R/results/rless_results_Rn6_untrimmed.csv", row.names = TRUE,sep="\t",quote=FALSE)
write.table(results_Rn6_trimmed, file="/home/tes9/Desktop/groupproject/files/R/results/rless_results_Rn6_trimmed.csv", row.names = TRUE,sep="\t",quote=FALSE)
...
plotMD(fit_Rn4_untrimmed, main = "Rn4_untrimmed",zero.weights=FALSE,xlim=c(-10,10),ylim=c(-10,10))
dev.off()

jpeg(paste("/home/tes9/Desktop/groupproject/files/graphs/Rn4_trimmed_Treat_MDplot.jpg", sep = ""))
plotMD(fit_Rn4_trimmed, main = "Rn4_trimmed",zero.weights=FALSE,xlim=c(-10,10),ylim=c(-10,10))
dev.off()

jpeg(paste("/home/tes9/Desktop/groupproject/files/graphs/Rn6_untrimmed_Treat_MDplot.jpg", sep = ""))
plotMD(fit_Rn6_untrimmed, main = "Rn6_untrimmed",zero.weights=FALSE,xlim=c(-10,10),ylim=c(-10,10))
dev.off()

jpeg(paste("/home/tes9/Desktop/groupproject/files/graphs/Rn6_trimmed_Treat_MDplot.jpg", sep = ""))
plotMD(fit_Rn6_trimmed, main = "Rn6_trimmed",zero.weights=FALSE,xlim=c(-10,10),ylim=c(-10,10))
dev.off()

# Volcano Plot (Treat)
jpeg(paste("/home/tes9/Desktop/groupproject/files/graphs/Rn4_untrimmed_Treat_Vplot.jpg", sep = ""))
plot(output_Rn4_untrimmed$logFC, -log10(output_Rn4_untrimmed$P.Value), pch=19, cex=0.2, col=ifelse(output_Rn4_untrimmed$logFC < -1.5, "red", ifelse(output_Rn4_untrimmed$logFC > 1.5, "red","black")), xlab = "logFC", ylab = "-log10(P-Val)",xlim=c(-10,10),ylim=c(0,10))
abline(h=1.3, col="blue")
abline(h=2, col="green")
dev.off()

jpeg(paste("/home/tes9/Desktop/groupproject/files/graphs/Rn4_trimmed_Treat_Vplot.jpg", sep = ""))
plot(output_Rn4_trimmed$logFC, -log10(output_Rn4_trimmed$P.Value), pch=19, cex=0.2, col=ifelse(output_Rn4_trimmed$logFC < -1.5, "red", ifelse(output_Rn4_trimmed$logFC > 1.5, "red","black")), xlab = "logFC", ylab = "-log10(P-Val)",xlim=c(-10,10),ylim=c(0,10))
abline(h=1.3, col="blue")
abline(h=2, col="green")
dev.off()

jpeg(paste("/home/tes9/Desktop/groupproject/files/graphs/Rn6_untrimmed_Treat_Vplot.jpg", sep = ""))
plot(output_Rn6_untrimmed$logFC, -log10(output_Rn6_untrimmed$P.Value), pch=19, cex=0.2, col=ifelse(output_Rn6_untrimmed$logFC < -1.5, "red", ifelse(output_Rn6_untrimmed$logFC > 1.5, "red","black")), xlab = "logFC", ylab = "-log10(P-Val)",xlim=c(-10,10),ylim=c(0,10))
abline(h=1.3, col="blue")
abline(h=2, col="green")
dev.off()

jpeg(paste("/home/tes9/Desktop/groupproject/files/graphs/Rn6_trimmed_Treat_Vplot.jpg", sep = ""))
plot(output_Rn6_trimmed$logFC, -log10(output_Rn6_trimmed$P.Value), pch=19, cex=0.2, col=ifelse(output_Rn6_trimmed$logFC < -1.5, "red", ifelse(output_Rn6_trimmed$logFC > 1.5, "red","black")), xlab = "logFC", ylab = "-log10(P-Val)",xlim=c(-10,10),ylim=c(0,10))
abline(h=1.3, col="blue")
abline(h=2, col="green")
dev.off()
